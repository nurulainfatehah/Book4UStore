...
$sqlMe = "SELECT * FROM staff WHERE username = '".$username."'";
		...
		if($fileError == 0) //PICTURE HAS NO PROBLEM 
		{
			if($fileSize < 10000) //PICTURE DOES NOT EXCEED 10MB
			{
				...
				move_uploaded_file($fileTmpName, $fileDestination);
						...
						//INSERT EVERY COLUMN
				$sqlRegister = "UPDATE staff SET picture = '".$fileNameNew."' WHERE username = '".$username."'";
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function (){
			...
			$('#getpermit').on('click', function(){
				window.open('travelpermit.php');
			});
...
<body>
	...
	<div class="boxHolder">
		<div class="profileholder"><span class="permiticon" id="getpermit">GET WORK TRAVEL<br>PERMIT HERE</span>
			<a class="changePicture" id="changepic" aria-label="Change Profile Picture">
				...
				<?php
				if($rowMe['accountStatus'] == "active"){
					?>
					<i style="color:green;">active</i>
					<?php
				}else{
					?>
					<i style="color:orange;">deactivated</i>
					<?php
				}
				?>
			</center>
			...
			<div class="information">
				<table align="center" width="90%" cellpadding="6">
					...
					<tr>
						...
						<td>
							<input id="pass2" placeholder="CONFIRM PASSWORD" type="password" name="pass2">
						</td>
					</tr>
				</table>
			</div>
