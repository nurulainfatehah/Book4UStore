...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/printlandscape.css">
...
<body onload="window.print()">
		<center>
			<p>Generated on: <?php echo date('d M Y h:i:s a', time()+25200)?></p>
			<i>This is a computer-generated report. No signature is required. © BOOK4U STORE. All rights reserved.</i><br>
			<br><br>

			<a class="printbutton" onclick="window.print()">
				Print
			</a>
		</center>
