...
if(isset($_GET['bookID'])){
	...
	if($result->num_rows == 0){
		...
		<script type="text/javascript">
			...
			window.location.href = "../BOOK4UStore";
		</script>
		<?php
	}else{
	...
	<body>
		...
		<div class="sortSearchHolder">
			...
			<center>
				...
				?>
					<li class="genre">
						<a class="genre" href="../BOOK4UStore/index.php?genre=<?php echo $row1['name'] ?>">
		            		<?php echo $row1['name']; ?>  
		            	</a>
		        <?php 
		        } 
		...
		<div class="maincontainer" >
			...
			<div class="description">
				...
				<div class="bookinfo">
					...
					if(empty($row['receiptID'])){
						?>
						<input type="submit" name="submit" value="ADD TO CART" class="buttonaddtocart" onclick="window.alert('Please sign in first');">
						<?php
					}else{
						?>
